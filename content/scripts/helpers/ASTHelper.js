var ASTHelper =
{
    ...
    {
    //prolazi� kroz cilo stablo, uzima ti cili program i puca ti do kraja stabla odnose roditelj-djeca, svi �vorovi
    ...
    flatten: function(program) //ti mi vra�a� "jednodimenzionalnu" hrpu �vorova
    {
        var nodes = [];
        ASTHelper.traverseAst(program, function(currentElement, name, parentElement)
        {
